	...
	****************************************************************************/
	...
	class notificaciones extends controller
	{
		...
		protected function index()
		{
			...
			$this->listaNotificacionesProximas = $notificaciones->getProxInterVisitas($this->notifydays);
			//var_dump($this->listaNotificacionesProximas);exit();
			$this->listaNotificacionesProximas = array_merge($this->listaNotificacionesProximas, $notificaciones->getGenerEmprenFaltanDocs());
			$this->listaNotificacionesPasadas = $notificaciones->getDocsFaltantVisitas();
			$this->listaNotificacionesPasadas = array_merge($this->listaNotificacionesPasadas, $notificaciones->getPasadInterVisitas());
