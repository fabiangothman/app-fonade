	...
	****************************************************************************/
	...
	class visitas extends controller
	{
		...
		protected function index()
		{
			...
			//Para enviar al js
			$this->listaDocsPropios = $visitas->getPropiosDocumentos($this->main->usuario->id);
			...
			$this->addInReadyCode("
				MSVisitas.init('"._MSFW_PATH_."', '"._MODEL_PATH_."', '"._VIEW_PATH_."', ".json_encode($this->listaDocsPropios).", '".$this->rol."');
				//
			");
		}
