	...
	****************************************************************************/
	...
	class documentos_emprendedor extends controller
	{
		...
		protected function index()
		{
			...
			$this->listaDocumentos_emprendedor = $documentos_emprendedor->getIntrvDocumentos_emprendedor($this->main->usuario->id);
			$this->listaDocumentos = $documentos_emprendedor->getIntrvAndEmprDocumentos($this->main->usuario->id);
			$this->listaProyectos = $documentos_emprendedor->getIntrvProyectos($this->main->usuario->id);

			//URL de carpeta de archivos del usuario
			$this->docs_folder = _MSFW_PATH_."documentos/";

			$this->addInReadyCode("
				MSDocumentos_emprendedor.init('"._MSFW_PATH_."', '"._MODEL_PATH_."', '"._VIEW_PATH_."', ".json_encode($this->listaDocumentos).", ".json_encode($this->listaProyectos).", '".$this->rol."');
				//
			");
		}
