	...
	****************************************************************************/
	...
	class visitas extends controller
	{
		...
		protected function index()
		{
			...
			$this->listaVisitas = $visitas->getLaeVisitas($this->main->usuario->id);
			
			$this->listaProyectos = $visitas->getLaeProyectos($this->main->usuario->id);
			$this->listaDocumentos = $visitas->getLaeDocumentos($this->main->usuario->id);
			...
			$this->addInReadyCode("
				MSVisitas.init('"._MSFW_PATH_."', '"._MODEL_PATH_."', '"._VIEW_PATH_."', ".json_encode($this->listaProyectos).", ".json_encode($this->listaDocumentos).", '".$this->rol."');
				//
			");
		}
