	...
	<div class="page_content">
		...
		<div class="modulo_page">
	        <div class="mod-wrapper">
	            <div class="mod-title">
	                <div class="row">
	                    <div class="col-sm-8"><h2>Información de <b>Notificaciones</b></h2></div>
	                    <div class="col-sm-12">
	                        <p>Aquí se muestran las notificaciones próximas y pasadas</p>
	                    </div>
	                </div>
	            </div>
	            ...
	            <div class="row">
		            <div class="croma col-sm-12">
		            	...
		            	<div class="item">
		            		...
		            		<div class="texto">Notificación con tiempo de reacción prudente (más de <?php echo $notifydays+7;?> días o no aplica)</div>
		            	</div>
		            	<div class="item">
